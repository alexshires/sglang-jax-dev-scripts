# Profiling Session Report: 2026-02-05
...
| Artifact | Location |
|----------|----------|
| Local trace (Perfetto) | `/Users/kanna/Sandbox/sglang-all/sglang-jax-dev-scripts/profiling-results/2026-02-05/t1v-n-c2bbebb4-w-0.trace.json.gz` |
| Local trace (XPlane) | `/Users/kanna/Sandbox/sglang-all/sglang-jax-dev-scripts/profiling-results/2026-02-05/t1v-n-c2bbebb4-w-0.xplane.pb` |
| GCS bucket | `gs://sglang-jax-profiling-results/2026-02-05-tinyllama-tpu-v6e/` |

### File Sizes

| File | Compressed | Decompressed |
|------|------------|--------------|
| trace.json.gz | 4.9 MB | 64 MB |
| xplane.pb | 18 MB | N/A |
...
2. Drag and drop `t1v-n-c2bbebb4-w-0.trace.json.gz`
...
To reproduce this profiling session:

1. Follow the Setup Commands above
2. Execute the Profiling Workflow
3. Download traces: `gcloud compute tpus tpu-vm scp sglang-profiling:/tmp/profile/plugins/profile/*/* ./traces/ --zone=us-east5-b`
4. View in Perfetto or TensorBoard
...
- [Runbook: Running Performance Benchmarks](../runbooks/running-performance-benchmarks.md)
